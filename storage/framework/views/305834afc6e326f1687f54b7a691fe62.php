...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel PlayStation Rental')); ?></title>
...
<body class="bg-slate-950 text-slate-300 min-h-screen flex flex-col relative overflow-x-hidden">
    ...
    <footer class="border-t border-slate-800/80 bg-slate-900/50 backdrop-blur text-sm text-center py-6 mt-auto">
        <p class="text-slate-500 font-display tracking-widest">&copy; <?php echo e(date('Y')); ?> GAMEZONE INC. ALL RIGHTS RESERVED.</p>
    </footer>
...
<?php /**PATH C:\Users\COMPUTER\Downloads\gamezone-rental-ps-main\gamezone-rental-ps-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>