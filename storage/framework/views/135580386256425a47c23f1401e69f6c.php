...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2 glass-panel rounded-2xl overflow-hidden p-6 border-t border-white/5">
        ...
        <?php if(session('success')): ?>
            <div class="bg-green-500/20 text-green-400 text-sm font-bold p-3 rounded mb-4"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-800/80">
                    ...
                    <tr class="hover:bg-slate-800/30 transition">
                        <td class="px-4 py-4">
                            <span class="font-mono bg-indigo-500/20 text-indigo-300 font-bold px-3 py-1 rounded border border-indigo-500/30"><?php echo e($promo->code); ?></span>
                        </td>
                        <td class="px-4 py-4 text-white font-bold">Rp <?php echo e(number_format($promo->discount_amount, 0, ',', '.')); ?></td>
                        <td class="px-4 py-4">
                        ...
                        <td class="px-4 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <form action="/admin/promo/toggle" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="code" value="<?php echo e($promo->code); ?>">
                                    <button type="submit" class="text-xs font-bold px-3 py-1 rounded border <?php echo e($promo->is_active ? 'border-red-500/50 text-red-400 hover:bg-red-500/20' : 'border-green-500/50 text-green-400 hover:bg-green-500/20'); ?> transition">
                                        <?php echo e($promo->is_active ? 'Matikan' : 'Aktifkan'); ?>

                                    </button>
                                </form>
                                <form action="/admin/promos/<?php echo e($promo->id); ?>" method="POST" onsubmit="return confirm('Hapus voucher promo ini?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\COMPUTER\Downloads\gamezone-rental-ps-main\gamezone-rental-ps-main\resources\views/backend/promos.blade.php ENDPATH**/ ?>