        ...
        <div class="bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
            ...
            <form method="POST" action="/login" class="space-y-6" autocomplete="off">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-medium text-blue-400 hover:text-blue-300 transition">Lupa Kata Sandi?</a>
                    </div>
            ...
            <div class="mt-8 text-center space-y-4">
                <div class="pt-4 border-t border-slate-800">
                    <p class="text-sm text-slate-400">Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-blue-400 hover:text-blue-300 font-semibold transition">Daftar di sini</a></p>
                </div>
...
<?php /**PATH C:\Users\COMPUTER\Downloads\gamezone-rental-ps-main\gamezone-rental-ps-main\resources\views/auth/login.blade.php ENDPATH**/ ?>